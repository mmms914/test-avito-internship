...
import (
	...
	"github.com/avito-internships/test-backend-1-mmms914/cmd/config"
	"github.com/avito-internships/test-backend-1-mmms914/internal/api"
	authH "github.com/avito-internships/test-backend-1-mmms914/internal/api/handlers/auth"
	bookingH "github.com/avito-internships/test-backend-1-mmms914/internal/api/handlers/booking"
	roomH "github.com/avito-internships/test-backend-1-mmms914/internal/api/handlers/room"
	scheduleH "github.com/avito-internships/test-backend-1-mmms914/internal/api/handlers/schedule"
	slotH "github.com/avito-internships/test-backend-1-mmms914/internal/api/handlers/slot"
	"github.com/avito-internships/test-backend-1-mmms914/internal/infra/hasher"
	"github.com/avito-internships/test-backend-1-mmms914/internal/infra/postgres"
	"github.com/avito-internships/test-backend-1-mmms914/internal/infra/zoom"
	bookingR "github.com/avito-internships/test-backend-1-mmms914/internal/repository/booking"
	roomR "github.com/avito-internships/test-backend-1-mmms914/internal/repository/room"
	scheduleR "github.com/avito-internships/test-backend-1-mmms914/internal/repository/schedule"
	slotR "github.com/avito-internships/test-backend-1-mmms914/internal/repository/slot"
	userR "github.com/avito-internships/test-backend-1-mmms914/internal/repository/user"
